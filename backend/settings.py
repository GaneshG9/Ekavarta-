"""
Django settings for Ekavarta AI Business Automation Platform.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-%gsc6%@x5l#89^yr%n!^vve()p(helv7uqw$5i3u(qxrkyqxp+')
...
# n8n Integration
N8N_API_URL = config('N8N_API_URL', default='http://localhost:5678')
